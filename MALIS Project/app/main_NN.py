...
NNlist = u.get_list_layers(feature) # Layers of the NN. Last layer is 5 for "NN", 20 for "N" or 15 for "O"
epochs=150
learning_rate=0.01
...
#middle = int(len(chords) / 2)
#last_chords = chords[middle : middle + 9]
# Generated chords
#predicted_future_stream = u.generate_music_stream(last_chords, 100)
# Load the prediction
#predicted_future_stream.write('midi', fp='/Users/aydinabiar/Desktop/MALIS Project/results/'+'generated'+'.mid')
