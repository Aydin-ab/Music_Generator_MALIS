...
def OLD_convert_chord_to_bits(chord) :
...
# If it's the first time we make that Neural Network
    ...
    # 38 is the dimension of the output vector y if y is a chord.
    # 5 is the dimension of the output vector y if y is the number of notes in a chord.
